...
#' @param aes_x The x axis variable name from 'df'. This is a required discrete numeric,
#'  Date/POSIXct variable.
#' @param aes_y The y axis variable name from 'df'. This is a required discrete numeric.
#' @param aes_label Sets the variable name from 'df' as the source for the tile's text.
#' @param aes_color The discrete/continuous variable name from 'df' for the aesthetic mapping for color.
#' @param aes_fill The discrete/continuous variable name from 'df' for the aesthetic mapping for fill.
#' @param aes_size The variable name from 'df' for the aesthetic mapping for size.
#' @param aes_width The variable name from 'df' for the aesthetic mapping for width.
#' @param aes_height The variable name from 'df' for the aesthetic mapping for height.
